...
CONF_HAS_DRY_MODE = "has_dry_mode"

AIDO_BASIC_HVAC_MODES = [HVAC_MODE_AUTO, HVAC_MODE_FAN_ONLY, HVAC_MODE_HEAT, HVAC_MODE_COOL, HVAC_MODE_OFF]
AIDO_FULL_HVAC_MODES = AIDO_BASIC_HVAC_MODES + [HVAC_MODE_DRY]
